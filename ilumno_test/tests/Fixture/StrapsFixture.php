 ...
 *
 */
class StrapsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'clasp_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'image' => ['type' => 'string', 'length' => 300, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'fk_straps_clasps1' => ['type' => 'index', 'columns' => ['clasp_id'], 'length' => []],
        ],
        '_constraints' => [
